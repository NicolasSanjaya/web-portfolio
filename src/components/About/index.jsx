...
const About = () => {
  ...
  return (
    <div className={`${isDarkMode ? "bg-slate-900 text-white" : ""} min-h-screen px-6 pb-12 flex flex-wrap justify-center items-center overflow-hidden`}>
      <div className="min-[1240px]:w-1/2 mt-28">
        <motion.div initial={{ opacity: 0, scale: 0.5, y: "-100%" }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
          <div className="min-[640px]:flex min-[640px]:justify-center">
            <svg
              viewBox="0 0 200 200"
              xmlns="http://www.w3.org/2000/svg"
              width={250}
              className=" absolute -z-20 top-16 translate-y-2 left-20 scale-150 max-[400px]:top-0 max-[400px]:left-6 max-[400px]:scale-110 min-[640px]:left-24 min-[640px]:top-16 min-[640px]:w-96 md:scale-110 min-[1240px]:left-24 min-[1240px]:top-16"
            >
              <path
                fill="#3B82F6"
      ...
      <div className="flex justify-center items-center flex-col min-[1240px]:w-1/2 mt-24">
        <motion.div initial={{ opacity: 0, scale: 0.5, y: "100%" }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
          <h1 className="text-center text-xl font-semibold">
            Hello my name is <br className="block md:hidden" />
            <span className="text-2xl font-bold text-blue-500">Nicolas Sanjaya</span>
          </h1>
          <p className="text-center mt-4 text-lg">
            I am Front End Developer and 5th semester student and currently studying web development. Here are some personal projects I&apos;ve. <span className="text-xl font-semibold text-blue-400">Keep learning on new technology.</span>
          </p>
