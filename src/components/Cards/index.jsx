...
const Card = (props) => {
  ...
  const { title = "Project Name", desc = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error ratione quidem harum optio placeat cupiditate. Consequatur distinctio expedita quam cum.", img = onprogress, link, tech } = props;
  return (
    <div className={`max-w-sm rounded-lg shadow m-4 ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border border-gray-200"}`}>
      ...
      <div className="p-5">
        ...
        <p className="font-semibold my-6">Stack Used : {tech}</p>
        <Button href={link} />
      </div>
    </div>
  );
